...
namespace TimeTraveller.Services.CaseFiles.Test
{
    ...
    public class TestCaseFileService
    {
        ...
        public void TestConvertXml2CaseFileAndBack()
        {
            ...
            string xml = @"<cs:CaseFile xmlns:cs=""http://timetraveller.net/storage/schemas/casefile.xsd"">
                                ...
                                <cs:Link rel=""self"" href=""http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.Harbers""/>
                                <Person>
        ...
        public void TestGetCaseFile()
        {
            ...
            ICaseFileService caseFileService = new CaseFileService(logger, container, caseFileSpecificationService, representationService, dataService);
            CaseFile result = caseFileService.Get(myspecification, "myobjectmodel/myspecification/Alex.Harbers", new Uri("http://localhost:8080/storage"));
            Assert.IsNotNull(result);

            logger.DebugFormat("Result={0}", result.Text);

            Assert.AreEqual("myobjectmodel/myspecification/Alex.Harbers", result.ExtId);
            Assert.AreEqual("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.Harbers?version=3", result.SelfUri);
            Assert.AreEqual("http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification?version=2", result.CaseFileSpecificationUri);
        ...
        public void TestGetCaseFileWithMultipleLevels()
        {
            ...
            Assert.AreEqual("http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification?version=2", result.CaseFileSpecificationUri);
            Assert.AreEqual("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.Harbers?version=8", result.SelfUri);
            Assert.IsTrue(result.Text.Contains("<Person"));
            Assert.IsTrue(result.Text.Contains("<FirstName>Alex</FirstName>"));
            Assert.IsTrue(result.Text.Contains("<LastName>Harbers</LastName>"));
        ...
        public void TestStoreNewCaseFile()
        {
            ...
            caseFileService.Store(myspecification, "myobjectmodel/myspecification/Alex.Harbers", caseFile, new Uri("http://localhost:8080/storage"), info);

            Assert.AreEqual("http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification?version=2", caseFile.CaseFileSpecificationUri);
            Assert.AreEqual("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.Harbers?version=4", caseFile.SelfUri);
        ...
        public void TestStoreNewValueInExistingObject()
        {
            ...
            Assert.AreEqual("http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification?version=2", caseFile.CaseFileSpecificationUri);
            Assert.AreEqual("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.Harbers?version=6", caseFile.SelfUri);
        ...
        public void TestStoreCaseFileWithInvalidXml()
        {
            ...
            ICaseFileService caseFileService = new CaseFileService(logger, container, caseFileSpecificationService, representationService, dataService);
            string caseFileXml = @"<cs:CaseFile xmlns:cs=""http://timetraveller.net/storage/schemas/casefile.xsd"">
                                        <cs:Link rel=""casefilespecification"" href=""""/>
                                        <cs:Link rel=""self"" href=""""/>
                                        <Person>
                                            <FirstName>Alex</FirstName>
            ...
            caseFileService.Store(caseFile.CaseFileSpecification, "myobjectmodel/myspecification/Alex.Harbers", caseFile, new Uri("http://localhost:8080/storage"), journalInfo);
        }
        ...
        public void TestStoreNewCaseFileWithMultipleLevels()
        {
            ...
            Assert.AreEqual("http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification?version=2", caseFile.CaseFileSpecificationUri);
            Assert.AreEqual("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.Harbers?version=8", caseFile.SelfUri);
        ...
        public void TestStoreExistingCaseFileWithMultipleLevelsInNewAndExistingObjects()
        {
            ...
            Assert.AreEqual("http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification?version=2", caseFile.CaseFileSpecificationUri);
            Assert.AreEqual("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.Harbers?version=10", caseFile.SelfUri);
        ...
        public void TestGetXmlSchemaText()
        {
            ...
            Assert.IsTrue(result.Contains(@"http://timetraveller.net/storage/schemas/casefile.xsd"));
        }
        ...
        public void TestGetCaseFiles()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Convert(myspecification.BaseObjectValue, new Uri("http://localhost:8080/storage"))).Return(myspecification).Repeat.Times(3);
            ...
            IEnumerable<CaseFile> casefiles = caseFileService.GetEnumerable(myspecification, new Uri("http://localhost:8080/storage"));
