...
namespace Luminis.Its.Services.ObjectModels.Test
{
    /// <summary>
    ...
    public class TestObjectModelService
    {
            ...
            LastCall.On(dataService).Do(
                new SaveChangesDelegate(
                    delegate()
                    {
                        ...
                        Assert.IsTrue(value.Text.Contains(@"xmlns=""http://luminis.net/its/schemas/objectmodel.xsd"""));
        ...
        public void TestGetXmlSchema()
        {
            ...
            Assert.IsTrue(result.Contains(@"http://luminis.net/its/schemas/objectmodel.xsd"));
        }
        ...
        public void TestGetSummary()
        {
            ...
            string result = objectModelService.GetSummary(objectModel, new Uri("http://localhost:8080/its"), Encoding.Unicode);
            ...
            Assert.IsTrue(result.Contains(@"<Link rel=""latest"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel"" />"));
            Assert.IsTrue(result.Contains(@"<Link rel=""current"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=3"" />"));
            Assert.IsTrue(result.Contains(@"<Link rel=""version"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=1"" />"));
            Assert.IsTrue(result.Contains(@"<Link rel=""version"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=2"" />"));
            Assert.IsTrue(result.Contains(@"<Link rel=""summary"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?summary=true"" />"));
            Assert.IsTrue(result.Contains(@"<Link rel=""history"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?history=true"" />"));
            Assert.IsTrue(result.Contains(@"<Link rel=""casefilespecification"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/"" />"));
            Assert.IsTrue(result.Contains(@"</Summary>"));
        }
        ...
        public void TestGetHistory()
        {
            ...
            string result = objectModelService.GetHistory(objectModel, new Uri("http://localhost:8080/its"), Encoding.Unicode);
