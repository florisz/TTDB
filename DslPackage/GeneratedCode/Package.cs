...
namespace Luminis.Its.Workbench.DslPackage
{
	...
	[VSShell::ProvideToolWindow(typeof(WorkbenchExplorerToolWindow), MultiInstances = false, Style = VSShell::VsDockStyle.Tabbed, Orientation = VSShell::ToolWindowOrientation.Right, Window = "{3AE79031-E1BC-11D0-8F78-00A0C9110057}")]
	[VSShell::ProvideToolWindowVisibility(typeof(WorkbenchExplorerToolWindow), Constants.WorkbenchEditorFactoryId)]
	[VSShell::ProvideEditorFactory(typeof(WorkbenchEditorFactory), 103, TrustLevel = VSShellInterop::__VSEDITORTRUSTLEVEL.ETL_AlwaysTrusted)]
	[VSShell::ProvideEditorExtension(typeof(WorkbenchEditorFactory), "." + Constants.DesignerFileExtension, 32)]
	...
	internal abstract partial class WorkbenchPackageBase : DslShell::ModelingPackage
	{
		/// <summary>
		...
		protected override void Initialize()
		{
			...
			this.RegisterEditorFactory(new WorkbenchEditorFactory(this));

			// Create the command set that handles menu commands provided by this package.
			WorkbenchCommandSet commandSet = new WorkbenchCommandSet(this);
			commandSet.Initialize();
			
			// Register the model explorer tool window for this DSL.
			this.AddToolWindow(typeof(WorkbenchExplorerToolWindow));
		...
		{
			global::Luminis.Its.Workbench.WorkbenchToolboxHelper toolboxHelper = new global::Luminis.Its.Workbench.WorkbenchToolboxHelper(this);
			try
			{
...
namespace Luminis.Its.Workbench.DslPackage
{
	...
	[VSTextTemplatingHost::ProvideDirectiveProcessor(typeof(global::Luminis.Its.Workbench.WorkbenchDirectiveProcessor), global::Luminis.Its.Workbench.WorkbenchDirectiveProcessor.WorkbenchDirectiveProcessorName, "A directive processor that provides access to Workbench files")]
	[global::System.Runtime.InteropServices.Guid(Constants.WorkbenchPackageId)]
	internal sealed partial class WorkbenchPackage : WorkbenchPackageBase
	{
	}
}