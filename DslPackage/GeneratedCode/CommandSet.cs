...
namespace Luminis.Its.Workbench.DslPackage
{
	...
	/// </summary>
	internal partial class WorkbenchCommandSet : WorkbenchCommandSetBase
	{
		/// <summary>
		/// Constructs a new WorkbenchCommandSet.
		/// </summary>
		public WorkbenchCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class WorkbenchCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new WorkbenchCommandSetBase.
		/// </summary>
		protected WorkbenchCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewWorkbenchExplorerCommand,
				typeof(WorkbenchEditorFactory).GUID);
		...
		{
			WorkbenchExplorerToolWindow explorer = this.WorkbenchExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected WorkbenchDocData CurrentWorkbenchDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as WorkbenchDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected WorkbenchDocView CurrentWorkbenchDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as WorkbenchDocView;
			}
		}
		...
		/// </summary>
		protected WorkbenchExplorerToolWindow WorkbenchExplorerToolWindow
		{
			get
			{
				WorkbenchExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(WorkbenchExplorerToolWindow), true) as WorkbenchExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				WorkbenchExplorerToolWindow explorerWindow = this.WorkbenchExplorerToolWindow;
