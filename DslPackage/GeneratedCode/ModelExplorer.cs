...
namespace Luminis.Its.Workbench.DslPackage
{
	...
	/// </summary>
	internal partial class WorkbenchExplorer : WorkbenchExplorerBase
	{
		/// <summary>
		/// Constructs a new WorkbenchExplorer.
		/// </summary>
		public WorkbenchExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the WorkbenchExplorerToolWindow.
	/// </summary>
	internal abstract class WorkbenchExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new WorkbenchExplorerBase.
		/// </summary>
		protected WorkbenchExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.WorkbenchExplorerMenu;
			}
		}
		...
		{
			get { return global::Luminis.Its.Workbench.ModelRoot.DomainClassId; }
		}
