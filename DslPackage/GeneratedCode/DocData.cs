...
namespace Luminis.Its.Workbench.DslPackage
{
	...
	/// </summary>
	internal partial class WorkbenchDocData : WorkbenchDocDataBase
	{
		/// <summary>
		/// Constructs a new WorkbenchDocData.
		/// </summary>
		public WorkbenchDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a Workbench document in memory.
	/// </summary>
	internal abstract class WorkbenchDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new WorkbenchDocDataBase.
		/// </summary>
		protected WorkbenchDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
                return global::Luminis.Its.Workbench.WorkbenchDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::Luminis.Its.Workbench.ModelRoot modelRoot = null;
			...
			global::Luminis.Its.Workbench.WorkbenchDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::Luminis.Its.Workbench.WorkbenchSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.Store, fileName, diagramFileName, schemaResolver, null /* no load-time validation */);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::Luminis.Its.Workbench.WorkbenchDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::Luminis.Its.Workbench.WorkbenchDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		protected virtual void OnDocumentLoaded()
		{
			...
			global::Luminis.Its.Workbench.ModelRoot modelRoot = this.RootElement as global::Luminis.Its.Workbench.ModelRoot;
			if (modelRoot != null)
			{
				...
				if (diagrams.Count > 0)
				{
					global::Luminis.Its.Workbench.ClassDiagram diagram = diagrams[0] as global::Luminis.Its.Workbench.ClassDiagram;
					if (diagram != null)
					{
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::Luminis.Its.Workbench.ModelRoot modelRoot = (global::Luminis.Its.Workbench.ModelRoot)this.RootElement;
			...
			if (diagrams.Count > 0 && (!saveAs || this.diagramDocumentLockHolder == null))
			{
				...
				if (diagram != null)
				{
					...
					try
					{
						...
						global::Luminis.Its.Workbench.WorkbenchSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::Luminis.Its.Workbench.WorkbenchSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::Luminis.Its.Workbench.WorkbenchDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::Luminis.Its.Workbench.WorkbenchSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				...
				if (modelRoot != null)
				{
					modelFile = global::Luminis.Its.Workbench.WorkbenchSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
