...
namespace Luminis.Its.Workbench.DslPackage
{
	...
	/// </summary>
	[global::System.Runtime.InteropServices.Guid(Constants.WorkbenchEditorFactoryId)]
	internal partial class WorkbenchEditorFactory : WorkbenchEditorFactoryBase
	{
		/// <summary>
		/// Constructs a new WorkbenchEditorFactory.
		/// </summary>
		public WorkbenchEditorFactory(global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class WorkbenchEditorFactoryBase : DslShell::ModelingEditorFactory
	{
		/// <summary>
		/// Constructor.
		/// </summary>
		/// <param name="serviceProvider">Service provider used to access VS services.</param>
		protected WorkbenchEditorFactoryBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override DslShell::ModelingDocData CreateDocData(string fileName, VSShellInterop::IVsHierarchy hierarchy, uint itemId)
		{
			...
			return new WorkbenchDocData(this.ServiceProvider, typeof(WorkbenchEditorFactory).GUID);
		}
		...
		protected override DslShell::ModelingDocView CreateDocView(DslShell::ModelingDocData docData, string physicalView, out string editorCaption)
		{
			...
			return new WorkbenchDocView(docData, this.ServiceProvider);
		}
	}
}
