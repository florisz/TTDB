...
namespace Luminis.Its.Workbench.DslPackage
{
	...
	/// </summary>
	internal partial class WorkbenchDocView : WorkbenchDocViewBase
	{
		/// <summary>
		/// Constructs a new WorkbenchDocView.
		/// </summary>
		public WorkbenchDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class WorkbenchDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new WorkbenchDocView.
		/// </summary>
		protected WorkbenchDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::Luminis.Its.Workbench.ClassDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::Luminis.Its.Workbench.ClassDiagram>();
			if (diagrams.Count > 0)
			{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::Luminis.Its.Workbench.WorkbenchToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::Luminis.Its.Workbench.WorkbenchToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.WorkbenchDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::Luminis.Its.Workbench.WorkbenchHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::Luminis.Its.Workbench.WorkbenchHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::Luminis.Its.Workbench.WorkbenchHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
