...
namespace TimeTraveller.Services.CaseFileSpecifications.Test
{
    /// <summary>
    ...
    public class TestCaseFileSpecificationService
    {
        ...
        public void TestConvertXml2CaseFileSpecificationWithMissingName()
        {
            ...
            string xml = @"<CaseFileSpecification xmlns=""http://timetraveller.net/storage/schemas/casefilespecification.xsd"">
        ...
        public void TestGetCaseFileSpecification()
        {
            ...
            BaseObjectValue specificationObjectValue = new BaseObjectValue()
            {
                ...
                Text = @"<CaseFileSpecification xmlns=""http://timetraveller.net/storage/schemas/casefilespecification.xsd"">
                               <Link rel=""objectmodel"" href=""""/>
                               <Link rel=""self"" href=""""/>
        ...
        public void TestGetUnknownCaseFileSpecification()
        {
            ...
            IObjectModelService objectModelService = new ObjectModelService(logger, container, dataService);
            ICaseFileSpecificationService specificationService = new CaseFileSpecificationService(logger, container, objectModelService, dataService);
            CaseFileSpecification specification = specificationService.Get("myobjectmodel/myspecification", new Uri("http://localhost:8080/storage"));
        }
        ...
        public void TestGetCaseFileSpecifications()
        {
            ...
            IObjectModelService objectModelService = new ObjectModelService(logger, container, dataService);
            ICaseFileSpecificationService specificationService = new CaseFileSpecificationService(logger, container, objectModelService, dataService);
            IEnumerable<CaseFileSpecification> specifications = specificationService.GetEnumerable("myobjectmodel", new Uri("http://localhost:8080/storage"));
        ...
        public void TestStoreNewCaseFileSpecification()
        {
            ...
            LastCall.On(dataService).Do(
                new SaveChangesDelegate(
                    delegate()
                    {
                        ...
                        Assert.IsTrue(value.Text.Contains(@"xmlns=""http://timetraveller.net/storage/schemas/casefilespecification.xsd"""));
            ...
            specificationService.Store(string.Format("myobjectmodel/{0}", specification.Name), specification, new Uri("http://localhost:8080/storage"), headerInfo);
        }
                ...
                new SaveChangesDelegate(
                    delegate()
                    {
                        try
                        {
                            ...
                            Assert.IsTrue(firstValue.Text.Contains(@"xmlns=""http://timetraveller.net/storage/schemas/casefilespecification.xsd"""));
                            ...
                            Assert.IsTrue(lastValue.Text.Contains(@"xmlns=""http://timetraveller.net/storage/schemas/casefilespecification.xsd"""));
        ...
        public void TestStoreCaseFileSpecificationWithUnknownEntity()
        {
            ...
            specificationService.Store(string.Format("myobjectmodel/{0}", specification.Name), specification, new Uri("http://localhost:8080/storage"), info);
        }
        ...
        public void TestGetXmlSchema()
        {
            ...
            Assert.IsTrue(result.Contains(@"http://timetraveller.net/storage/schemas/casefilespecification.xsd"));
        }
...
<CaseFileSpecification xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns=""http://timetraveller.net/storage/schemas/casefilespecification.xsd"">
  <Link rel=""objectmodel"" href=""http://localhost:8080/storage/specifications/objectmodels/Automobile"" />
  <Link rel=""self"" href="""" />
