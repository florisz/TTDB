	...
	{
        public ObjectModel(string name, string filename)
		{
			this.Name = name;
        ...
        public string Uri()
        {
            return string.Format("{0}/specifications/objectmodels/{1}", );
        }
    }

	public class CaseFileSpec
	{
