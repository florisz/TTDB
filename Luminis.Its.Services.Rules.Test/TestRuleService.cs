...
namespace Luminis.Its.Services.Rules.Test
{
    /// <summary>
    ...
    public class TestRuleService
    {
        ...
        public void TestConvertRuleToXmlAndBack()
        {
            ...
            Rule myrule = new Rule()
            {
                ...
                SelfUri = "http://localhost:8080/its/rules/myobjectmodel/myspecification/myrule",
...
let Execute(p: Person) =
    ...
    p.NumberOfHousesSpecified &lt;- true
            ...
            Rule myrule = ruleService.Get("myobjectmodel/myspecification/myrule", new Uri("http://localhost:8080/its"));
...
let Execute(p: Person) =
    ...
    p.NumberOfHousesSpecified <- true"
            ...
            ruleService.Store("myobjectmodel/myspecification/myrule", myrule, new Uri("http://localhost:8080/its"), info);
        ...
        public void TestGetXmlSchema()
        {
            ...
            Assert.IsTrue(result.Contains(@"http://luminis.net/its/schemas/rule.xsd"));
        }
    }
}
