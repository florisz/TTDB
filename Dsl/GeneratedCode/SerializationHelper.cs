...
namespace Luminis.Its.Workbench
{
	...
	public partial class ModelRootSerializer
	{
				...
				if (schemaResolver != null)
				{
					...
					if (!string.IsNullOrEmpty(targetNamespace))
					{
						...
						if (schemas != null && schemas.Count > 0)
						{
							if (schemas.Count > 1)
							{
								WorkbenchSerializationBehaviorSerializationMessages.AmbiguousSchema(serializationContext, reader, targetNamespace, schemas[0]);
							}
							...
							WorkbenchSerializationBehaviorSchemaValidationCallback validationCallback = new WorkbenchSerializationBehaviorSchemaValidationCallback(serializationContext);
						...
						{
							WorkbenchSerializationBehaviorSerializationMessages.NoSchema(serializationContext, reader, targetNamespace);
						}
					}
				}
		...
		private static void CheckVersion(DslModeling::SerializationContext serializationContext, global::System.Xml.XmlReader reader)
		{
			...
			if (dslVersionStr != null)
			{
				try
				{
					...
					{
						WorkbenchSerializationBehaviorSerializationMessages.VersionMismatch(serializationContext, reader, expectedVersion, actualVersion);
					}
				}
				catch (global::System.ArgumentException)
				{
					WorkbenchSerializationBehaviorSerializationMessages.InvalidPropertyValue(serializationContext, reader, "dslVersion", typeof(global::System.Version), dslVersionStr);
				}
		...
		/// </summary>
		private sealed class WorkbenchSerializationBehaviorSchemaValidationCallback
		{
			...
			internal WorkbenchSerializationBehaviorSchemaValidationCallback(DslModeling::SerializationContext serializationContext)
			{
				global::System.Diagnostics.Debug.Assert(serializationContext != null);
			...
			internal void Handler(object sender, global::System.Xml.Schema.ValidationEventArgs e)
			{
				...
				if (this.serializationContext != null)
					WorkbenchSerializationBehaviorSerializationMessages.SchemaValidationError(this.serializationContext, this.reader, e.Message);
			}
			#endregion
		}
		...
		public override void WriteRootElement(DslModeling::SerializationContext serializationContext, DslModeling::ModelElement element, global::System.Xml.XmlWriter writer)
		{
			...
			rootElementSettings.SchemaTargetNamespace = "http://schemas.microsoft.com/dsltools/Workbench";
...
{
	/// <summary>
	/// Helper class for serializing and deserializing Workbench models.
	/// </summary>
	public abstract partial class WorkbenchSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Constructor
		/// </summary>
		protected WorkbenchSerializationHelperBase() { }
		#endregion
		...
		public virtual ModelRoot LoadModel(DslModeling::SerializationResult serializationResult, DslModeling::Partition partition, string fileName, DslModeling::ISchemaResolver schemaResolver, DslValidation::ValidationController validationController)
		{
			...
			{
				throw new global::System.InvalidOperationException(WorkbenchDomainModel.SingletonResourceManager.GetString("MissingTransaction"));
			}
			...
			if (modelRootSerializer != null)
			{
				using (global::System.IO.FileStream fileStream = global::System.IO.File.OpenRead(fileName))
				{
					using (DslModeling::Transaction t = partition.Store.TransactionManager.BeginTransaction("Load Model from " + fileName, true))
					{
						...
						// Set up MonikerResolver for Workbench.
		...
		internal protected virtual ClassDiagram CreateDiagramHelper(DslModeling::Partition diagramPartition, DslModeling::ModelElement modelRoot)
		{
			...
			if (DslModeling::DomainRoleInfo.GetAllElementLinks(modelRoot).Count == 0)
			{
				...
				mappedElement = new ObjectModelSpec(diagramPartition);
				elementGroup.Add(mappedElement);
				elementGroup.MarkAsRoot(mappedElement);
				mappedElement = new CaseFileModelSpec(diagramPartition);
				elementGroup.Add(mappedElement);
				elementGroup.MarkAsRoot(mappedElement);
		...
		public virtual string GetSerializedModelString(global::Luminis.Its.Workbench.ModelRoot modelRoot, global::System.Text.Encoding encoding)
		{
		...
		/// <summary>
		/// DomainXmlSerializerDirectory instance used by this WorkbenchSerializationHelper class.
		/// </summary>
		...
		protected virtual DslModeling::DomainXmlSerializerDirectory Directory
		{
			...
			get
			{
				if (this.directory == null)
				{
					...
					directory.AddBehavior(WorkbenchSerializationBehavior.Instance);
				}
		...
		internal protected virtual global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> GetMonikerResolvers(DslModeling::Store store)
		{
			...
			result.Add(WorkbenchDomainModel.DomainModelId, new WorkbenchSerializationBehaviorMonikerResolver(store, this.Directory));
			return result;
		}
	...
	/// Helper class for serializing and deserializing Workbench models.
	/// </summary>
	public sealed partial class WorkbenchSerializationHelper : WorkbenchSerializationHelperBase
	{
		#region Constructor
		/// <summary>
		/// Private constructor to prevent direct instantiation.
		/// </summary>
		private WorkbenchSerializationHelper() : base () { }
		#endregion
		...
		/// Singleton instance.
		/// </summary>
		private static WorkbenchSerializationHelper instance;
		/// <summary>
		/// Singleton instance.
		/// </summary>
		[global::System.Diagnostics.DebuggerBrowsable(global::System.Diagnostics.DebuggerBrowsableState.Never)] // Will trigger creation otherwise.
		public static WorkbenchSerializationHelper Instance
		{
			[global::System.Diagnostics.DebuggerStepThrough]
			get
			{
				if (WorkbenchSerializationHelper.instance == null)
					WorkbenchSerializationHelper.instance = new WorkbenchSerializationHelper();
				return WorkbenchSerializationHelper.instance;
			}
		}
		#endregion
	}
...
namespace Luminis.Its.Workbench
{
	...
	public partial class ModelRoot
	{
		...
		private void ValidateMonikerAmbiguity(DslValidation::ValidationContext context)
		{
			...
			global::System.Collections.Generic.IDictionary<global::System.Guid, DslModeling::IMonikerResolver> monikerResolvers = WorkbenchSerializationHelper.Instance.GetMonikerResolvers(this.Store);
						...
						{	// Ambiguous moniker detected.
							context.LogError(
								string.Format(
									...
									WorkbenchDomainModel.SingletonResourceManager.GetString("AmbiguousMoniker"),
									amEx.Moniker,
