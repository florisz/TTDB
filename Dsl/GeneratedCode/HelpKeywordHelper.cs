...
namespace Luminis.Its.Workbench
{
	...
	/// </remarks>
	public partial class WorkbenchHelpKeywordHelper : WorkbenchHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new WorkbenchHelpKeywordHelper.
		/// </summary>
		protected WorkbenchHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the WorkbenchHelpKeywordHelper.
		/// </summary>
		public static WorkbenchHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class WorkbenchHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new WorkbenchHelpKeywordHelperBase.
		/// </summary>
		protected WorkbenchHelpKeywordHelperBase()
			: base() { }
