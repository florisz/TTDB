...
namespace Luminis.Its.Services.Resources.Test
{
    /// <summary>
    ...
    public class TestResourceService
    {
        ...
        public void TestGetBuiltInResource()
        {
            ...
            Resource myresource = resourceService.Get("images/luminis.png", new Uri("http://localhost:8080/its"));

            Assert.AreEqual("images/luminis.png", myresource.ExtId);
        ...
        public void TestCannotStoreBuiltInResource()
        {
            ...
            resourceService.Store("images/luminis.png", myresource, new Uri("http://localhost:8080/its"), info);
        }
        ...
        public void TestGetResourcesAsHtml()
        {
            ...
            string xml = @"<Resources>
                                <Resource>
                                    <Link rel=""resource"" href=""http://localhost:8080/its/resources/images/luminis.png""/>
                                </Resource>
                                <Resource>
