...
namespace Luminis.Its.Services.Rest.Test
{
    /// <summary>
    ...
    public class TestRestService
    {
        ...
        public void TestGetLatestCaseFileSpecification()
        {
            ...
            myspecification.ObjectModelUri = myspecification.ObjectModel.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);
            myspecification.SelfUri = myspecification.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);

            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Get("myobjectmodel/myspecification", new Uri("http://localhost:8080/its"))).Return(myspecification);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification");
                string result = Encoding.UTF8.GetString(resultBuffer);
                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=2"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""self"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification?version=1"" />"));
        ...
        public void TestGetLatestCaseFileSpecificationXmlSchema()
        {
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification.xsd");
                string result = Encoding.UTF8.GetString(resultBuffer);
                _logger.DebugFormat("result={0}", result);
        ...
        public void TestGetCaseFileSpecificationByTimePoint()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Get("myobjectmodel/myspecification", timePoint, new Uri("http://localhost:8080/its"))).Return(myspecification);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification?timepoint=2009-01-01T13:50:10");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetCaseFileSpecificationByVersion()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Get("myobjectmodel/myspecification", myspecification.BaseObjectValue.Version, new Uri("http://localhost:8080/its"))).Return(myspecification);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification?version=1");
                string result = Encoding.UTF8.GetString(resultBuffer);
                _logger.DebugFormat("result={0}", result);
        ...
        public void TestGetUnknownCaseFileSpecification()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Get("myobjectmodel/unknownspecification", new Uri("http://localhost:8080/its"))).Do(
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/casefiles/myobjectmodel/unknownspecification");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetCaseFileSpecifications()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.GetEnumerable("myobjectmodel", new Uri("http://localhost:8080/its"))).Return(specifications);

            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.GetList(specifications, new Uri("http://localhost:8080/its"), Encoding.Unicode)).Do(
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/casefiles/myobjectmodel/");
                string result = Encoding.Unicode.GetString(resultBuffer);
                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""casefilespecification"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/firstspecification?summary=true"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""casefilespecification"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/secondspecification?summary=true"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestGetLatestCaseFile()
        {
            ...
            caseFile.CaseFileSpecificationUri = caseFile.CaseFileSpecification.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);
            caseFile.SelfUri = caseFile.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);
            Expect.On(caseFileService).Call(caseFileService.Get(myspecification, "myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers", new Uri("http://localhost:8080/its"))).Return(caseFile);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("Result={0}", result);

                Assert.IsTrue(result.Contains(@"<cs:CaseFile"));
                Assert.IsTrue(result.Contains(@"xmlns:cs=""http://luminis.net/its/schemas/casefile.xsd"""));
                Assert.IsTrue(result.Contains(@"<cs:Link rel=""casefilespecification"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification?version=1"" />"));
                Assert.IsTrue(result.Contains(@"<cs:Link rel=""self"" href=""http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers?version=2"" />"));
        ...
        public void TestGetCaseFileByVersion()
        {
            ...
            caseFile.CaseFileSpecificationUri = caseFile.CaseFileSpecification.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);
            caseFile.SelfUri = caseFile.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);
            Expect.On(caseFileService).Call(caseFileService.Get(myspecification, "myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers", 2, new Uri("http://localhost:8080/its"))).Return(caseFile);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers?version=2");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetCaseFileByTimePoint()
        {
            ...
            Expect.On(caseFileService).Call(caseFileService.Get(myspecification, "myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers", timePoint, new Uri("http://localhost:8080/its"))).Return(caseFile);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers?timepoint=2009-01-01T14:10:35.9800106%2B01:00");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetCaseFileWithUnknownCaseFileSpecification()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Get("myobjectmodel/myspecification", new Uri("http://localhost:8080/its"))).Return(null);
            ...
            try
            {
                ...
                Stream httpStream = webClient.OpenRead("http://localhost:8080/its/casefiles/myobjectmodel/myspecification/mycasefileidentifier/ThisIsFixed/mycasefilesubidentifier?thirdidentifier=mythirdidentifier");
        ...
        public void TestGetUnmatchedCaseFile()
        {
            ...
            try
            {
                ...
                Stream httpStream = webClient.OpenRead("http://localhost:8080/its/casefiles/myobjectmodel/myspecification/mycasefileidentifier/ThisIsUnmatched/mycasefilesubidentifier/thirdidentifier=mycasefilethirdidentifier");
        ...
        public void TestGetCaseFiles()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Get(myspecification.ExtId, new Uri("http://localhost:8080/its"))).Return(myspecification);
            ...
            Expect.On(caseFileService).Call(caseFileService.GetEnumerable(myspecification, new Uri("http://localhost:8080/its"))).Return(casefiles);

            Expect.On(caseFileService).Call(caseFileService.GetList(casefiles, new Uri("http://localhost:8080/its"), Encoding.Unicode)).Do(
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/casefiles/myobjectmodel/myspecification/");
                string result = Encoding.Unicode.GetString(resultBuffer);
                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""casefile"" href=""http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex.Harbers?summary=true"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""casefile"" href=""http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Floris.Zwarteveen?summary=true"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestStoreCaseFileSpecification()
        {
            ...
            Expect.On(objectModelService).Call(objectModelService.Get("myobjectmodel", new Uri("http://localhost:8080/its"))).Return(objectmodel);
            ...
            caseFileSpecificationService.Store(string.Empty, null, new Uri("http://localhost:8080/its"), null);
            ...
            try
            {
                ...
                Assert.IsTrue(result.Contains(@"<Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=1"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""self"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification?version=2"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestStoreInvalidCaseFileSpecificationWithMissingName()
        {
            ...
            try
            {
                ...
                string specificationXml = @"<CaseFileSpecification xmlns=""http://luminis.net/its/schemas/specification.xsd"">
                                                    <Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel""/>
                                                    <Link rel=""self"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification""/>
                                                    <UriTemplate>{primaryidentfier}/{secundaryidentifier}?thirdidentifier={thirdidentifier}</UriTemplate>
                                                </CaseFileSpecification>";
        ...
        public void TestGetLatestObjectModel()
        {
            ...
            myobjectmodel.SelfUri = myobjectmodel.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);

            Expect.On(objectModelService).Call(objectModelService.Get("myobjectmodel", new Uri("http://localhost:8080/its"))).Return(myobjectmodel);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/objectmodels/myobjectmodel");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""self"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=1"" />"));
        ...
        public void TestGetLatestObjectModelXmlSchema()
        {
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/objectmodels/myobjectmodel.xsd");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetObjectModelByTimePoint()
        {
            ...
            Expect.On(objectModelService).Call(objectModelService.Get("myobjectmodel", timePoint, new Uri("http://localhost:8080/its"))).Return(myobjectmodel);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/objectmodels/myobjectmodel?timepoint=2009-01-01");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetObjectModelByVersion()
        {
            ...
            Expect.On(objectModelService).Call(objectModelService.Get("myobjectmodel", 1, new Uri("http://localhost:8080/its"))).Return(myobjectmodel);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=1");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetObjectModelHistory()
        {
            ...
            List<IJournalEntry> journalEntries = new List<IJournalEntry>()
            {
                new BaseObjectJournal()
                {
                    ...
                    Username = "alex.harbers@luminis.nl",
                ...
                new BaseObjectJournal()
                {
                    ...
                    Username = "floris.zwarteveen@luminis.nl",
                ...
                new BaseObjectJournal()
                {
                    ...
                    Username = "rob.vanroooijen@luminis.nl",
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/objectmodels/myobjectmodel?history=true");
                string result = Encoding.UTF8.GetString(resultBuffer);
                ...
                Assert.IsTrue(result.Contains(@"<Username>alex.harbers@luminis.nl</Username>"));
                Assert.IsTrue(result.Contains(@"</Journal>"));
                Assert.IsTrue(result.Contains(@"<Journal>"));
                Assert.IsTrue(result.Contains(@"<Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=2"" />"));
                Assert.IsTrue(result.Contains(@"<Timestamp>06-25-2009 09:21 42</Timestamp>"));
                Assert.IsTrue(result.Contains(@"<Username>floris.zwarteveen@luminis.nl</Username>"));
                Assert.IsTrue(result.Contains(@"</Journal>"));
                Assert.IsTrue(result.Contains(@"<Journal>"));
                Assert.IsTrue(result.Contains(@"<Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=3"" />"));
                Assert.IsTrue(result.Contains(@"<Timestamp>06-25-2009 09:22 00</Timestamp>"));
                Assert.IsTrue(result.Contains(@"<Username>rob.vanroooijen@luminis.nl</Username>"));
                Assert.IsTrue(result.Contains(@"</Journal>"));
                Assert.IsTrue(result.Contains(@"</History>"));
            }
            catch (Exception exception)
        ...
        public void TestGetObjectModels()
        {
            ...
            Expect.On(objectModelService).Call(objectModelService.GetEnumerable(new Uri("http://localhost:8080/its"))).Return(objectmodels);

            Expect.On(objectModelService).Call(objectModelService.GetList(objectmodels, new Uri("http://localhost:8080/its"), Encoding.UTF8)).Do(
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/specifications/objectmodels/");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/firstobjectmodel?summary=true"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/secondobjectmodel?summary=true"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestStoreObjectModel()
        {
            ...
            objectModelService.Store(string.Empty, null, new Uri("http://localhost:8080/its"), null);
        ...
        public void TestStoreInvalidObjectModel()
        {
            ...
            try
            {
                ...
                Assert.IsNotNull(result);
                Assert.IsTrue(result.Contains(@"<Link rel=""self"" href=""http://localhost:8080/its/specifications/objectmodels/myobjectmodel?version=2"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestStoreCaseFile()
        {
            ...
            caseFileService.Store(myspecification, "myobjectmodel/myspecification/Alex.MiddleName.Harbers", null, new Uri("http://localhost:8080/its"), null);
            ...
            try
            {
                ...
                Assert.IsTrue(result.Contains(@"<cs:CaseFile"));
                Assert.IsTrue(result.Contains(@"<cs:Link rel=""casefilespecification"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification?version=1"""));
                Assert.IsTrue(result.Contains(@"<cs:Link rel=""self"" href=""http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex.MiddleName.Harbers?version=2"""));
                Assert.IsTrue(result.Contains(@"<Person"));
                Assert.IsTrue(result.Contains(@"<FirstName>Alex</FirstName>"));
                Assert.IsTrue(result.Contains(@"<LastName>Harbers</LastName>"));
                Assert.IsTrue(result.Contains(@"</cs:CaseFile>"));
        ...
        public void TestLatestGetRepresentation()
        {
            ...
            myrepresentation.SelfUri = myrepresentation.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);

            Expect.On(representationService).Call(representationService.Get(myrepresentation.ExtId, new Uri("http://localhost:8080/its"))).Return(myrepresentation);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/representations/myobjectmodel/myspecification/myrepresentation");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""self"" href=""http://localhost:8080/its/representations/myobjectmodel/myspecification/myrepresentation?version=1"" />"));
        ...
        public void TestGetRepresentations()
        {
            ...
            Expect.On(representationService).Call(representationService.GetEnumerable("myobjectmodel", "myspecification", new Uri("http://localhost:8080/its"))).Return(representations);

            Expect.On(representationService).Call(representationService.GetList(representations, new Uri("http://localhost:8080/its"), Encoding.UTF8)).Do(
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/representations/myobjectmodel/myspecification/");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""representation"" href=""http://localhost:8080/its/representations/myobjectmodel/myspecification/firstrepresentation?summary=true"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""representation"" href=""http://localhost:8080/its/representations/myobjectmodel/myspecification/secondrepresentation?summary=true"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestStoreRepresentation()
        {
            ...
            int index = 0;
            representationService.Store(string.Empty, null, new Uri("http://localhost:8080/its"), null);
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Get(myspecification.Name, new Uri("http://localhost:8080/its"))).Return(myspecification);
        ...
        public void TestGetLatestCaseFileUsingRepresentation()
        {
            ...
            Expect.On(caseFileService).Call(caseFileService.Get(myspecification, caseFile.ExtId, new Uri("http://localhost:8080/its"))).Return(caseFile);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex/ThisIsFixed/MiddleName/Harbers?view=myrepresentation");
                string result = Encoding.UTF8.GetString(resultBuffer);
...
let Execute(p: Person) =
    true"
            ...
            myrule.SelfUri = myrule.GetUri(new Uri("http://localhost:8080/its"), UriType.Version);

            Expect.On(ruleService).Call(ruleService.Get(myrule.ExtId, new Uri("http://localhost:8080/its"))).Return(myrule);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/rules/myobjectmodel/myspecification/myrule");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""self"" href=""http://localhost:8080/its/rules/myobjectmodel/myspecification/myrule?version=1"" />"));
        ...
        public void TestGetRules()
        {
            ...
            Expect.On(ruleService).Call(ruleService.GetEnumerable("myobjectmodel", "myspecification", new Uri("http://localhost:8080/its"))).Return(rules);

            Expect.On(ruleService).Call(ruleService.GetList(rules, new Uri("http://localhost:8080/its"), Encoding.UTF8)).Do(
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/rules/myobjectmodel/myspecification/");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""rule"" href=""http://localhost:8080/its/rules/myobjectmodel/myspecification/firstrule?summary=true"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""rule"" href=""http://localhost:8080/its/rules/myobjectmodel/myspecification/secondrule?summary=true"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestStoreRule()
        {
            ...
            int index = 0;
            ruleService.Store(string.Empty, null, new Uri("http://localhost:8080/its"), null);
            ...
            try
            {
                ...
                string ruleXml = @"<Rule xmlns=""http://luminis.net/its/schemas/rule.xsd"">
                                        <Link rel=""casefilespecification"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification""/>
...
let Execute(p: Person) =
    true
        ...
        public void TestExecuteRuleByVersion()
        {
            ...
            Expect.On(caseFileService).Call(caseFileService.GetXml(resultingCaseFile, Encoding.Unicode)).IgnoreArguments().Return(string.Format(@"<cs:CaseFile xmlns:cs=""http://luminis.net/its/schemas/casefile.xsd"">
                                                <cs:Link rel=""self"" href=""http://localhost:8080/its/casefiles/myobjectmodel/myspecification/Alex.MiddleName.Harbers""/>
                                                <cs:Link rel=""casefilespecification"" href=""http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification""/>
                                                <Person RegistrationId=""{0}"" RegistrationStart=""{1}"">
                                                    <FirstName>Alex</FirstName>
            ...
            Expect.On(ruleService).Call(ruleService.Get(myrule.ExtId, myrule.Version, new Uri("http://localhost:8080/its"))).Return(myrule);
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.UploadData("http://localhost:8080/its/rules/myobjectmodel/myspecification/myrule?version=1", "POST", requestBuffer);
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetXmlSchemas()
        {
            ...
            Expect.On(objectModelService).Call(objectModelService.GetXmlSchemaAddress(new Uri("http://localhost:8080/its"))).Return("http://localhost:8080/its/schemas/objectmodel.xsd");

            ICaseFileSpecificationService caseFileSpecificationService = _mocks.StrictMock<ICaseFileSpecificationService>();
            Expect.On(_unity).Call(_unity.Resolve<ICaseFileSpecificationService>()).Return(caseFileSpecificationService);

            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.GetXmlSchemaAddress(new Uri("http://localhost:8080/its"))).Return("http://localhost:8080/its/schemas/casefilespecification.xsd");

            ICaseFileService caseFileService = _mocks.StrictMock<ICaseFileService>();
            Expect.On(_unity).Call(_unity.Resolve<ICaseFileService>()).Return(caseFileService);

            Expect.On(caseFileService).Call(caseFileService.GetXmlSchemaAddress(new Uri("http://localhost:8080/its"))).Return("http://localhost:8080/its/schemas/casefile.xsd");

            IRepresentationService representationService = _mocks.StrictMock<IRepresentationService>();
            Expect.On(_unity).Call(_unity.Resolve<IRepresentationService>()).Return(representationService);

            Expect.On(representationService).Call(representationService.GetXmlSchemaAddress(new Uri("http://localhost:8080/its"))).Return("http://localhost:8080/its/schemas/representation.xsd");

            IRuleService ruleService = _mocks.StrictMock<IRuleService>();
            Expect.On(_unity).Call(_unity.Resolve<IRuleService>()).Return(ruleService);

            Expect.On(ruleService).Call(ruleService.GetXmlSchemaAddress(new Uri("http://localhost:8080/its"))).Return("http://localhost:8080/its/schemas/rule.xsd");
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/schemas/");
                string result = Encoding.UTF8.GetString(resultBuffer);

                _logger.DebugFormat("result={0}", result);

                Assert.IsTrue(!string.IsNullOrEmpty(result));
                Assert.IsTrue(result.Contains(@"<Link rel=""schema"" href=""http://localhost:8080/its/schemas/objectmodel.xsd"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""schema"" href=""http://localhost:8080/its/schemas/casefilespecification.xsd"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""schema"" href=""http://localhost:8080/its/schemas/casefile.xsd"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""schema"" href=""http://localhost:8080/its/schemas/representation.xsd"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""schema"" href=""http://localhost:8080/its/schemas/rule.xsd"" />"));
            }
            catch (Exception exception)
            {
                _logger.Error("", exception);
        ...
        public void TestGetXmlSchema()
        {
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/schemas/rule.xsd");
                string result = Encoding.UTF8.GetString(resultBuffer);
        ...
        public void TestGetRepositoryInfo()
        {
            ...
            try
            {
                ...
                byte[] resultBuffer = webClient.DownloadData("http://localhost:8080/its/");
                string result = Encoding.UTF8.GetString(resultBuffer);
                ...
                Assert.IsTrue(result.Contains(@"<Link rel=""schema"" href=""http://localhost:8080/its/schemas/"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""objectmodel"" href=""http://localhost:8080/its/specifications/objectmodels/"" />"));
                Assert.IsTrue(result.Contains(@"<Link rel=""resource"" href=""http://localhost:8080/its/resources/"" />"));
                Assert.IsTrue(result.Contains(@"</Links>"));
            }
            catch (Exception exception)
            {
