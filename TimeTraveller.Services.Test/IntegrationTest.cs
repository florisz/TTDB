    ...
    public class IntegrationTest
    {
        ...
        public void TestStoreAndRetrieve()
        {
            ...
            try
            {
                ...
                webClient.Headers.Add(HttpRequestHeader.ContentType, "application/xml; charset=utf-16");
                webClient.Headers.Add(HttpRequestHeader.From, "user1@gmail.com");
                resultBuffer = webClient.UploadData("http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification", "PUT", requestBuffer);
                ...
                webClient.Headers.Add(HttpRequestHeader.ContentType, "application/xml; charset=utf-16");
                webClient.Headers.Add(HttpRequestHeader.From, "user1@gmail.com");
                resultBuffer = webClient.UploadData("http://localhost:8080/storage/representations/myobjectmodel/myspecification/myrepresentation", "PUT", requestBuffer);
                result = Encoding.Unicode.GetString(resultBuffer);
                ...
                webClient.Headers.Add(HttpRequestHeader.ContentType, "application/xml; charset=utf-16");
                webClient.Headers.Add(HttpRequestHeader.From, "user1@gmail.com");
                resultBuffer = webClient.UploadData("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.MiddleName.Harbers", "PUT", requestBuffer);
                result = Encoding.Unicode.GetString(resultBuffer);

                _logger.DebugFormat("StoreCaseFile()={0}", result.Replace("\n", "\r\n"));

                webClient.Headers.Add(HttpRequestHeader.ContentType, "application/xml; charset=utf-16");
                resultBuffer = webClient.DownloadData("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.MiddleName.Harbers");
                result = Encoding.Unicode.GetString(resultBuffer);
                ...
                webClient.Headers.Add(HttpRequestHeader.ContentType, "application/xml; charset=utf-16");
                resultBuffer = webClient.DownloadData("http://localhost:8080/storage/casefiles/myobjectmodel/myspecification/Alex.MiddleName.Harbers?view=myrepresentation");
                result = Encoding.Unicode.GetString(resultBuffer);
                Assert.IsNotNull(result);
                ...
                string ruleXml = @"<?xml version=""1.0"" encoding=""utf-16""?>
                            <Rule xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns=""http://timetraveller.net/storage/schemas/rule.xsd"">
                              <Link rel=""casefilespecification"" href=""http://localhost:8080/storage/specifications/casefiles/myobjectmodel/myspecification""/>
                              <Link rel=""self"" href=""http://localhost:8080/storage/rules/myobjectmodel/myspecification/myrules"" />
                              <Name>MyRule</Name>
...
let Execute(p: Person) =
    p.Rules &lt;- ""done.""</Script>
                ...
                webClient.Headers.Add(HttpRequestHeader.ContentType, "application/xml; charset=utf-16");
                webClient.Headers.Add(HttpRequestHeader.From, "user1@gmail.com");
                resultBuffer = webClient.UploadData("http://localhost:8080/storage/rules/myobjectmodel/myspecification/myrule", "PUT", requestBuffer);
                result = Encoding.Unicode.GetString(resultBuffer);
                ...
                //string executeRuleRequest = "http://localhost:8080/storage/rules/myobjectmodel/myspecification/myrule";
                //webClient.Headers.Add(HttpRequestHeader.ContentType, "application/xml; charset=utf-16");
