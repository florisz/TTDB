...
namespace Luminis.Its.Services.Representations.Test
{
    /// <summary>
    ...
    public class TestRepresentationService
    {
        ...
        public void TestConvertRepresentationToXmlAndBack()
        {
            ...
            Representation myrepresentation = new Representation()
            {
                ...
                CaseFileSpecificationUri = "http://localhost:8080/its/specifications/casefiles/myobjectmodel/myspecification",
                SelfUri = "http://localhost:8080/its/representations/myobjectmodel/myspecification/mypresentation",
        ...
        public void TestGetRepresentation()
        {
            ...
            Expect.On(caseFileSpecificationService).Call(caseFileSpecificationService.Convert(specificationValue, new Uri("http://localhost:8080/its"))).Return(myspecification);
            ...
            BaseObjectValue representationValue = new BaseObjectValue()
            {
                ...
                Text = @"<?xml version=""1.0"" encoding=""utf-16""?>
                            <Representation xmlns:xsi=""http://www.w3.org/2001/XMLSchema-instance"" xmlns:xsd=""http://www.w3.org/2001/XMLSchema"" xmlns=""http://luminis.net/its/schemas/representation.xsd"">
            ...
            Representation myrepresentation = representationService.Get("myobjectmodel/myspecification/myrepresentation", new Uri("http://localhost:8080/its"));
        ...
        public void TestStoreRepresentation()
        {
            ...
            representationService.Store("myobjectmodel/myspecification/myrepresentation", myrepresentation, new Uri("http://localhost:8080/its"), info);
        ...
        public void TestGetXmlSchema()
        {
            ...
            Assert.IsTrue(result.Contains(@"http://luminis.net/its/schemas/representation.xsd"));
        }
    }
}
