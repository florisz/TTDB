    ...
    <xsl:element name="test-results">
      ...
      <xsl:element name="test-suite">
        ...
        <xsl:attribute name="name">
          <xsl:value-of select="t:TestRun/t:TestRunConfiguration/@name"/>
        </xsl:attribute>
        ...
        <xsl:attribute name="success">
          <xsl:choose>
            <xsl:when test="$executedTests=$passedTests">
            ...
            <xsl:element name="test-case">
              ...
              <xsl:attribute name="time">
                <xsl:value-of select="
                              ...
                              round((substring(/t:TestRun/t:Results/t:UnitTestResult[@testId=$id]/@duration, 9, 4)))"/>
