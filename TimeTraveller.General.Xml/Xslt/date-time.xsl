...
<xsl:stylesheet version="1.0"
  ...
  extension-element-prefixes="str">
    ...
    <referenceinfo>
      <releaseinfo role="meta">
        $Id: date-time.xsl,v 1.11 2004/10/10 06:18:57 balls Exp $
      </releaseinfo>
      <author>
  ...
  <xsl:template name="dt:date-time-is-empty">
    <xsl:param name='xsd-date-time'/>

    <xsl:choose>
      <xsl:when test="$xsd-date-time and ($xsd-date-time='0001-01-01T00:00:00' or $xsd-date-time='0001-01-01T00:00:00.0000000')">
    ...
    <xsl:choose>
      ...
      <xsl:when test='$xsd-date-time'>
        <xsl:variable name="isEmpty">
          <xsl:call-template name="dt:date-time-is-empty">
